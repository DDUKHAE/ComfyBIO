...
_GOLD_DIR = Path(__file__).resolve().parent.parent / "gold" / "domains" / "genome_assembly"

_FAMILIES = [
    "short_read_assembly", "long_read_assembly", "hybrid_assembly",
    "assembly_qc", "polishing", "repeat_masking",
    "prokaryote_annotation", "eukaryote_annotation", "comparative_genomics",
    "scaffolding", "contamination_check", "binning",
]


class CS6GenomeAssemblyPlugin(DomainPlugin, HarnessMixin):
    ...
    def domain_description(self) -> str:
        return "De novo genome assembly, polishing, and annotation — CS6"

    def get_tsr(self) -> DomainTSR:
        return load_domain_tsr("genome_assembly")
